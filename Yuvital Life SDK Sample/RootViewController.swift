...
final class RootViewController: UIViewController {
  ...
  private var cards: [YuvitalCardConfig] = []
  ...
  private lazy var collectionView: UICollectionView = {
    ...
    collectionView.register(
      YuvitalCardCell.self, forCellWithReuseIdentifier: YuvitalCardCell.reuseIdentifier)
...
private final class YuvitalCardCell: UICollectionViewCell {
  ...
  func configure(with config: YuvitalCardConfig) {
    ...
    isUserInteractionEnabled = (config.action != nil)
  }
...
extension UIColor {
  fileprivate static let primaryCard = UIColor(red: 0.40, green: 0.45, blue: 0.88, alpha: 1.0)
  fileprivate static let secondaryCard = UIColor(red: 0.09, green: 0.09, blue: 0.12, alpha: 1.0)
}
